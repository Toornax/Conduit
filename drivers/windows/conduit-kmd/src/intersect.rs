...
//!
//! # Les listes d'attributs ne passent pas par ici (M1b-22)
//!
//! Depuis M1b-22, une entrée sur deux du tableau `DataRanges` d'une broche de flux n'est
//! pas une plage mais une `KSATTRIBUTE_LIST` (driver-design.md §4.3). Ce module n'en voit
