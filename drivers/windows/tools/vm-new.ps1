...
Write-Host "     Microsoft a retiré OOBE\BYPASSNRO et ms-cxh:localonly des images récentes."
Write-Host "     Si un compte Microsoft est imposé, voir docs/vm-bringup.md §1 :"
Write-Host "     déconnecter la carte réseau, poser BypassNRO en registre, redémarrer."
